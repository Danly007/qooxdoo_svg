...
var envinfo = {"qx.application":"qooxdoo_svg.Application","qx.revision":"","qx.theme":"qooxdoo_svg.theme.Theme","qx.version":"5.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qooxdoo_svg":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../../qooxdoo-master/framework/source/resource","sourceUri":"../../qooxdoo-master/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
